...
Bei dem Bau der Bienenstockwaage, lief nicht alles so gut wie geplant. Die Wägezellen, die ich mir aus China bestellt hatte, kame wegen Corona erst nach zwei Monaten an. Deswegen konnte ich, als ich beim Programmieren des ersten Prototyps, bemerkte das eine oder mehrere der Zellen nicht richtig funktioniereten, keine neuen bestellen.

Ohne die funktionirende Hardware war es mir unmöglich, Fehler in der Programmierung des Mikrocontrollers zu erkennen.
