...
Ein Webserver zum Beispiel stellt eine Internetseite ins Netz.~\footcite[ver.][]{IonosServer}
...
Eine API kann von Anwendungsbereich zu Anwendungsbereich komplett verschieden sein.~\footcite[][]{GSApi}
