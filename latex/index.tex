...
Ohne die funktionirende Hardware war es mir unmöglich, Fehler in der Programmierung des Mikrocontrollers zu erkennen, weswegen ich die Waage nicht fertigstellen konnte.

\section{Fazit} % {{{1

% Nächstes man kein Javascript für den Server aufgrund of no static type
