...
Ein solcher Standart ist \textbf{REST} (kurz für \enquote{\textbf{Representational State Transfer}}\footnote{Englisch für \textit{Repräsentative Zustantsübertragung}}).
...
Wenn man sich die Daten anschauen will, kann man dies über eine Webseite die mit Hilfe einer REST-API\footnote{Was eine REST-API ist können sie in Abschnitt~\ref{sec:api} lesen.} mit dem Server verbunden ist.
