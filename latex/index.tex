...
Javascript ist eine Programmiersprache die dafür entwickelt wurde um Webseiten interaktiv zu gestalten.
Sie ist sehr einfach zu lernen, ist allerdings im Vergleich zu anderen Programmiersprachen ziemlich langsam.
In Javascript muss man nicht festlegen welchen Typ eine Variable hat.
...
Beim überlegen wie ich mein Serversystem auf baue, welche Technologien ich benutzt war mir ziemlich schnell klar das ich so viel wie möglich in Javascript programmieren will.
